package com.parkingpin.app.data
...
import com.parkingpin.app.domain.detection.CandidateHistoryEntry
...
class DetectionStateStore(
     ...
     * [com.parkingpin.app.detection.ParkingCandidateCoordinator] is the one place that
    ...
    suspend fun updateCandidate(
         ...
         *
         * Null for a transform that is not a resolution — [com.parkingpin.app.detection
     ...
     * [com.parkingpin.app.trace.FileTraceStore] — because the rolling cap evicts whole
     * sessions.
     */

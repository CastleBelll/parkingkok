...
import com.parkingpin.app.analytics.DisabledAnalyticsRecorder
...
sealed interface ConfirmCandidateResult {
     ...
     * alone.
     *
     * Same refusal [com.parkingpin.app.domain.parking.usecase.SaveManualParkingUseCase]
...
class ParkingCandidateCoordinator(
    ...
    suspend fun create(
         ...
         *
         * [com.parkingpin.app.domain.detection.ParkingDetectionEngine] records the

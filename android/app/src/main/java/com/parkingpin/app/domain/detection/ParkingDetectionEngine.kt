...
import com.parkingpin.app.domain.location.MovementEvidencePolicy
 ...
 * calls live in [com.parkingpin.app.detection.ParkingDetectionRuntime].
 *
 * `startBoundedLocationCapture` / `stopLocationCapture` are **not** here on purpose:
 * [com.parkingpin.app.domain.location.LocationCaptureModePolicy] already decides the shape
...
class ParkingDetectionEngine(
     ...
     * [com.parkingpin.app.detection.ParkingDetectionRuntime] — the counter belongs to the

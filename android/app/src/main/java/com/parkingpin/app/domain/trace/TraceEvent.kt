 ...
 * [com.parkingpin.app.domain.location.LocationQualitySample] makes on the detection path.
 ...
 * [com.parkingpin.app.domain.location.ReliableLocationSelector.MAX_ACCURACY_METERS] happens

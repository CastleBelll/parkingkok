...
import com.parkingkok.app.domain.detection.DetectionEffect
 ...
 * [com.parkingkok.app.AppContainer] makes for Room and for photos. Only an effect that
 * actually reaches the user calls it.
 *
 * ### What it does not own
 * The Fused Location request. [com.parkingkok.app.domain.location.LocationCaptureModePolicy]
 ...
 * [com.parkingkok.app.domain.detection.ActivityTransitionMapper] already applies one layer

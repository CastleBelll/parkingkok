...
/**
 * The file half of [com.parkingkok.app.domain.photo.ParkingPhotoStore]: where a parking
...
class ParkingPhotoFiles(private val directory: File) {
     ...
     * put; resolving `../../databases/parkingkok-parking.db` to a real file and deleting

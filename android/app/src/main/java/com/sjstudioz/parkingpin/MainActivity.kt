...
import com.sjstudioz.parkingpin.detection.ParkingCandidateChannel
...
import com.sjstudioz.parkingpin.ui.navigation.ParkingpinApp
...
class MainActivity : ComponentActivity() {
     ...
     *
     * ```sh
     * adb shell am start -n com.sjstudioz.parkingpin/.MainActivity --ez pk_firebase_selfcheck true
     * ```
     *
     * There is no backend feature yet, so nothing in the product calls
     * [com.sjstudioz.parkingpin.identity.AnonymousIdentity]. This is how both the sign-in and the
     ...
     *
     * ```sh
     * adb shell am start -n com.sjstudioz.parkingpin/.MainActivity \
     ...
     * [com.sjstudioz.parkingpin.detection.ParkingDetectionRuntime] at compressed timestamps.
     *
     * **It bypasses nothing that decides.** The events go through the same reducer,
     * the same §3a table, the same §8 scoring and the same
     * [com.sjstudioz.parkingpin.detection.ParkingCandidateCoordinator] a Play services transition

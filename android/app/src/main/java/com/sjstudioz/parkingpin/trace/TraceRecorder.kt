...
import com.sjstudioz.parkingpin.domain.trace.TraceLabelPrompt
...
import com.sjstudioz.parkingpin.domain.trace.TraceSessionSplit
 ...
 * structural guarantee [com.sjstudioz.parkingpin.domain.trace.TraceEvent] gives the file format.
...
class TraceRecorder(
     ...
     * event is new — the [com.sjstudioz.parkingpin.domain.detection.DetectionCheckpoint] and
     * [com.sjstudioz.parkingpin.domain.location.LocationDiagnosticsCounters.lastSampleAtMillis],

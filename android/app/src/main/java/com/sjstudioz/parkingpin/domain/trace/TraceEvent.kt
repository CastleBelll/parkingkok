 ...
 * [com.sjstudioz.parkingpin.domain.location.LocationQualitySample] makes on the detection path.
 ...
 * [com.sjstudioz.parkingpin.domain.location.ReliableLocationSelector.MAX_ACCURACY_METERS] happens

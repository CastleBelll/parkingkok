...
class DetectionStateStore(
     ...
     * [com.sjstudioz.parkingpin.detection.ParkingCandidateCoordinator] is the one place that
    ...
    suspend fun updateCandidate(
         ...
         *
         * Null for a transform that is not a resolution — [com.sjstudioz.parkingpin.detection
     ...
     * [com.sjstudioz.parkingpin.trace.FileTraceStore] — because the rolling cap evicts whole
     * sessions.
     */

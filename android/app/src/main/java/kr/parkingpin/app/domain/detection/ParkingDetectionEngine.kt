...
import kr.parkingpin.app.domain.location.MovementEvidencePolicy
 ...
 * calls live in [kr.parkingpin.app.detection.ParkingDetectionRuntime].
 *
 * `startBoundedLocationCapture` / `stopLocationCapture` are **not** here on purpose:
 * [kr.parkingpin.app.domain.location.LocationCaptureModePolicy] already decides the shape
...
class ParkingDetectionEngine(
     ...
     * [kr.parkingpin.app.detection.ParkingDetectionRuntime] — the counter belongs to the

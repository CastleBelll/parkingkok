...
import kr.parkingpin.app.analytics.AnalyticsCollectionGate
import kr.parkingpin.app.analytics.AnalyticsConsentStore
import kr.parkingpin.app.analytics.AnalyticsRecorder
import kr.parkingpin.app.analytics.AnalyticsRecording
import kr.parkingpin.app.analytics.AnalyticsSink
import kr.parkingpin.app.analytics.FirebaseAnalyticsCollectionControl
import kr.parkingpin.app.analytics.FirebaseAnalyticsSink
import kr.parkingpin.app.analytics.LogAnalyticsSink
import kr.parkingpin.app.analytics.NoAnalyticsCollectionControl
import kr.parkingpin.app.analytics.NoOpAnalyticsSink
...
import kr.parkingpin.app.data.detectionDataStore
import kr.parkingpin.app.data.parking.ParkingDatabase
import kr.parkingpin.app.data.parking.RoomParkingRepository
import kr.parkingpin.app.data.photo.CameraCaptureFile
import kr.parkingpin.app.data.photo.FileParkingPhotoImageLoader
import kr.parkingpin.app.data.photo.FileParkingPhotoStore
import kr.parkingpin.app.data.photo.JpegPhotoEncoder
import kr.parkingpin.app.data.photo.ParkingPhotoFiles
import kr.parkingpin.app.data.photo.MlKitPillarTextReader
import kr.parkingpin.app.data.photo.ParkingPhotoImageLoader
import kr.parkingpin.app.detection.ActivityTransitionRegistrar
import kr.parkingpin.app.detection.DetectionRegistrationCoordinator
import kr.parkingpin.app.detection.FusedLocationSessionController
import kr.parkingpin.app.detection.FusedLocationSessionRegistrar
import kr.parkingpin.app.detection.NotificationCandidateDelivery
import kr.parkingpin.app.detection.ParkingCandidateCoordinator
import kr.parkingpin.app.detection.ParkingDetectionRuntime
import kr.parkingpin.app.detection.TransitionEventIngestor
import kr.parkingpin.app.diagnostics.DiagnosticsExporter
import kr.parkingpin.app.diagnostics.FileDiagnosticsReportStore
import kr.parkingpin.app.domain.parking.ParkingLocationProvider
import kr.parkingpin.app.domain.parking.ParkingRepository
import kr.parkingpin.app.domain.parking.usecase.AttachParkingPhotoUseCase
import kr.parkingpin.app.domain.parking.usecase.CleanUpOrphanPhotosUseCase
import kr.parkingpin.app.domain.photo.ParkingPhotoStore
import kr.parkingpin.app.domain.photo.PillarTextReader
import kr.parkingpin.app.domain.photo.ReadPillarSuggestionUseCase
import kr.parkingpin.app.ui.manual.PillarPhotoEntry
import kr.parkingpin.app.domain.trace.TraceDeviceInfo
import kr.parkingpin.app.domain.widget.ParkingWidgetSync
...
import kr.parkingpin.app.trace.FileTraceStore
import kr.parkingpin.app.trace.NotificationLabelPromptDelivery
import kr.parkingpin.app.trace.TraceLabelPrompter
import kr.parkingpin.app.trace.TraceRecorder
import android.Manifest
import android.content.pm.PackageManager
import androidx.core.content.ContextCompat
import android.os.PowerManager
import kr.parkingpin.app.domain.parking.usecase.EndParkingUseCase
import kr.parkingpin.app.widget.CompositeWidgetProjectionStore
import kr.parkingpin.app.widget.GlanceWidgetProjectionStore
import kr.parkingpin.app.widget.LockScreenParkingNotice
import kr.parkingpin.app.widget.anyParkingWidgetPlaced
...
class AppContainer(context: Context, val clock: Clock = SystemClock) {
     ...
     * [kr.parkingpin.app.trace.NotificationLabelPromptDelivery], which is the point —

...
import kr.parkingpin.app.domain.trace.TraceSessionSplit
import kr.parkingpin.app.domain.trace.TraceSplitResult
 ...
 * structural guarantee [kr.parkingpin.app.domain.trace.TraceEvent] gives the file format.
...
class TraceRecorder(
     ...
     * event is new — the [kr.parkingpin.app.domain.detection.DetectionCheckpoint] and
     * [kr.parkingpin.app.domain.location.LocationDiagnosticsCounters.lastSampleAtMillis],

...
import kr.parkingpin.app.analytics.DistanceBucket
import kr.parkingpin.app.analytics.DriveDurationBucket
import kr.parkingpin.app.data.DetectionStateStore
import kr.parkingpin.app.domain.detection.DetectionEffect
import kr.parkingpin.app.domain.detection.DetectionEngineState
import kr.parkingpin.app.domain.detection.DetectionEvent
import kr.parkingpin.app.domain.detection.MotionDomainEvent
import kr.parkingpin.app.domain.detection.MotionEventKind
import kr.parkingpin.app.domain.detection.ParkingDetectionEngine
 ...
 * [kr.parkingpin.app.AppContainer] makes for Room and for photos. Only an effect that
 * actually reaches the user calls it.
 *
 * ### What it does not own
 * The Fused Location request. [kr.parkingpin.app.domain.location.LocationCaptureModePolicy]
 ...
 * [kr.parkingpin.app.domain.detection.ActivityTransitionMapper] already applies one layer

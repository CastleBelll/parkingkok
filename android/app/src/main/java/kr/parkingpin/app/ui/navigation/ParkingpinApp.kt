...
import kr.parkingpin.app.map.ExternalMapOpener
import kr.parkingpin.app.ui.motion.LocalMotionEnabled
import kr.parkingpin.app.ui.motion.MotionDurations
import kr.parkingpin.app.ui.confirm.ConfirmCandidateScreen
import kr.parkingpin.app.ui.confirm.ConfirmCandidateViewModel
import kr.parkingpin.app.ui.detail.ParkingDetailScreen
import kr.parkingpin.app.ui.detail.ParkingDetailViewModel
import kr.parkingpin.app.ui.diagnostics.DiagnosticsScreen
import kr.parkingpin.app.ui.diagnostics.DiagnosticsViewModel
import kr.parkingpin.app.ui.history.HistoryScreen
import kr.parkingpin.app.ui.history.HistoryViewModel
import kr.parkingpin.app.ui.home.HomeScreen
import kr.parkingpin.app.ui.home.HomeViewModel
import kr.parkingpin.app.ui.manual.ManualParkingScreen
import kr.parkingpin.app.ui.manual.ManualParkingViewModel
import kr.parkingpin.app.ui.notifications.NotificationHistoryScreen
import kr.parkingpin.app.ui.notifications.NotificationHistoryViewModel
import kr.parkingpin.app.ui.photo.rememberCameraCapture
import kr.parkingpin.app.identity.GoogleCredentialRequest
import kr.parkingpin.app.ui.settings.SettingsScreen
import kr.parkingpin.app.ui.settings.SettingsViewModel
        ...
        onSignIn = {
            viewModel.onSignIn {
                GoogleCredentialRequest(
                    context = context,
                    // Generated by the google-services plugin from the same config the app
                    // is built with, so it cannot drift from the registered project. The
                    // *web* client id is the right one: Credential Manager wants the server
                    // the token is minted for, and the Android entry authorises the asking.

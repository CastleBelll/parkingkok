...
import kr.parkingpin.app.analytics.DisabledAnalyticsRecorder
...
sealed interface ConfirmCandidateResult {
     ...
     * alone.
     *
     * Same refusal [kr.parkingpin.app.domain.parking.usecase.SaveManualParkingUseCase]
...
class ParkingCandidateCoordinator(
    ...
    suspend fun create(
         ...
         *
         * [kr.parkingpin.app.domain.detection.ParkingDetectionEngine] records the
